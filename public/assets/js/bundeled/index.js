...
})({"9jxTt":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "b8e5beffa3b6ddc5";
module.bundle.HMR_BUNDLE_ID = "f0283a6db2986e61";
"use strict";
...
},{}],"2wwGt":[function(require,module,exports) {
/* eslint-disable */ var _custom = require("./custom");
...
if (loginForm) loginForm.addEventListener("click", (e)=>{
    e.preventDefault();
...
//   });
if (updateMetalDataForm) updateMetalDataForm.addEventListener("click", (e)=>{
    e.preventDefault();
    ...
    for(let i = 0; i < 6; i++)form.append("Images", document.getElementById("image").files[i]);
    for(let i1 = 0; i1 < 2; i1++)form.append("DimensionalRollerBallekitImages", document.getElementById("DimensionalRollerBallekitImages").files[i1]);
    // form.append('NTZ', document.getElementById('ntz').files[0]);
    (0, _updateSettings.updateMetalData)(form, "data");
});
if (finalform) finalform.addEventListener("click", (e)=>{
    e.preventDefault();
    const form = new FormData();
    ...
    // }
    for (let key of form.entries())console.log(key[0], key[1]);
    (0, _updateSettings.updatePumpData)(form, "data");
});

},{"./custom":"8soYi","@babel/polyfill":"@babel/polyfill","./updateSettings":"dqD7A"}],"8soYi":[function(require,module,exports) {
...
const login = async (employeeNumber, password)=>{
    ...
    try {
        ...
        (0, _alerts.showAlert)("danger", err.response.data.message);
    }
};
const logout = async ()=>{
    try {
...
},{"@babel/polyfill":"@babel/polyfill","axios":"axios","./alerts":"aKV4H","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"aKV4H":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dqD7A":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateData", ()=>updateData);
parcelHelpers.export(exports, "updateMetalData", ()=>updateMetalData);
parcelHelpers.export(exports, "updatePumpData", ()=>updatePumpData);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _polyfill = require("@babel/polyfill");
var _alerts = require("alerts");
...
const updateData = async (data)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url: "http://localhost:3000/api/v1/metallurgical/" + last_part,
            data
        });
        if (res.data.status === "success") {
...
const updateMetalData = async (data)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
...
const updatePumpData = async (data)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
            url: "/api/v1/pump",
...
},{"axios":"axios","@babel/polyfill":"@babel/polyfill","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt","alerts":"alerts"}]},["9jxTt","2wwGt"], "2wwGt", "parcelRequire11c7")
