      ...
      const onChecked = () => {
        ...
        if (checkedCheckbox.length) {
          $(".material-table__toolbar").html(`
            <div>
            <h5 class="material-table__toolbar-selected">${checkedCheckbox.length}<span> selected</span></h5>
            </div>
            <div class="material-class">
                 <button class="mdl-button mdl-js-button mdl-button--icon" id="deleteButton"><i class="material-icons">delete</i></button>
            </div>
...
<div>
          ...
          <div class="material-class material-table__filter-menu">
           <button id="demo-menu-lower-right" class="mdl-button mdl-js-button mdl-button--icon"><i class="material-icons">filter_list</i></button>
            <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="demo-menu-lower-right">
              <li class="mdl-menu__item material-table__filter-menu-item">Name</li>
              <li class="mdl-menu__item material-table__filter-menu-item">Calories</li>
              <li class="mdl-menu__item material-table__filter-menu-item">Fat</li>
              <li class="mdl-menu__item material-table__filter-menu-item">Carbs</li>
              <li class="mdl-menu__item material-table__filter-menu-item">Protein</li>
              </ul>
              </div>
          `).promise().done(function () {
      ...
      const insertData = (page, items) => {
        ...
        $(".mdl-data-table--selectable tbody tr").on('mouseup', function (e) {
