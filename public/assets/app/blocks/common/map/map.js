$(document).ready(function () {
  if (document.getElementById('map1') &&
    window.location.href.includes('google_map') || window.location.href.includes('online_marketing_dashboard')
    || window.location.href.includes('fitness_dashboard')) {
    ...
    window.window.infowindow = new window.InfoBox({
     ...
     <div class="map__marker-label">
            <div class="map__marker-label-content">
            <div class="map__maker-label-close" onclick="window.window.infowindow.close()">
  ...
  if (window.location.href.indexOf('vector_map') > -1 && document.getElementById('vector-map1')) {
    const config = {
      chart: {
        spacingBottom: 20,
