...
if (updateMetalDataForm) updateMetalDataForm.addEventListener('click', function (e) {
  ...
  for (var _i2 = 0; _i2 < 6; _i2++) {
    form.append('ComplateLobes', document.getElementById('ComplateLobes').files[_i2]);
  }

  for (var _i3 = 0; _i3 < 2; _i3++) {
    form.append('SlimFacePhoto', document.getElementById('SlimFacePhoto').files[_i3]);
  }

  for (var _i4 = 0; _i4 < 2; _i4++) {
    form.append('ClawPhoto', document.getElementById('ClawPhoto').files[_i4]);
  }

  for (var _i5 = 0; _i5 < 4; _i5++) {
    form.append('CrossDisk', document.getElementById('CrossDisk').files[_i5]);
  }

  for (var _i6 = 0; _i6 < 2; _i6++) {
    form.append('DriveShaft', document.getElementById('DriveShaft').files[_i6]);
  }

  for (var _i7 = 0; _i7 < 4; _i7++) {
    form.append('Roller', document.getElementById('Roller').files[_i7]);
  }

  for (var _i8 = 0; _i8 < 2; _i8++) {
    form.append('SteelWasherHead', document.getElementById('SteelWasherHead').files[_i8]);
  }

  for (var _i9 = 0; _i9 < 2; _i9++) {
    form.append('RollerRing', document.getElementById('RollerRing').files[_i9]);
  }

  for (var _i10 = 0; _i10 < 2; _i10++) {
    form.append('Housing', document.getElementById('Housing').files[_i10]);
